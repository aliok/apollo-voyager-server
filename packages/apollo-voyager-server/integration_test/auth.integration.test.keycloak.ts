...
const realmToImport: any = JSON.parse(fs.readFileSync('./config/realm-export.json') as any)
...
export async function resetKeycloakConfiguration () {
  await axios({
    method: 'DELETE',
...
async function authenticateKeycloak (t) {
